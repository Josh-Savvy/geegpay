	...
	return (
		<aside
			className={classNames(
				"overflow-hidden xs:overflow-visible duration-300 bg-[#F7F8FA] dark:bg-[#191919] fixed h-screen xs:sticky top-0 left-0 flex flex-col xs:items-center z-40 py-6",
