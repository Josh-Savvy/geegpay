...
export const MenuIcon = ({ size, color, is_active, ...rest }: IconProps & { is_active: boolean }) => {
	return (
		<svg {...rest} width={size || "24"} height={size || "24"} viewBox="0 0 24 24" fill="none">
			<path
				d="M7.24 2H5.34C3.15 2 2 3.15 2 5.33V7.23C2 9.41 3.15 10.56 5.33 10.56H7.23C9.41 10.56 10.56 9.41 10.56 7.23V5.33C10.57 3.15 9.42 2 7.24 2Z"
				fill={is_active ? "#0D062D" : "none"}
				stroke={is_active ? "" : "#B2ABAB"}
			/>
			<path
...
export const UsersIcon = ({ color, size, ...rest }: IconProps) => {
	return (
		<svg {...rest} width={size || "24"} height={size || "24"} viewBox="0 0 24 24" fill="none">
			<path
...
export const BoxIcon = ({ color, size, ...rest }: IconProps) => {
	return (
		<svg {...rest} width={size || "24"} height={size || "24"} viewBox="0 0 24 24" fill="none">
			<path
...
export const DiscountIcon = ({ color, size, ...rest }: IconProps) => {
	return (
		<svg {...rest} width={size || "24"} height={size || "24"} viewBox="0 0 24 24" fill="none">
			<path
...
export const InfoIcon = ({ color, size, ...rest }: IconProps) => {
	return (
		<svg {...rest} width={size || "24"} height={size || "24"} viewBox="0 0 24 24" fill="none">
			<path
				d="M12 8V13"
